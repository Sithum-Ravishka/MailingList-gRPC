...
// MailServer struct implements the MailingListServiceServer interface generated by gRPC.
type MailServer struct {
	pb.UnimplementedMailingListServiceServer         // Embed the unimplemented server to satisfy the interface.
	db                                       *sql.DB // Database connection
}

// pbEntryToMdbEntry converts a Protocol Buffers (pb) EmailEntry to a mdb.EmailEntry.
...
// mdbEntryToPbEntry converts a mdb.EmailEntry to a Protocol Buffers (pb) EmailEntry.
...
// emailResponse retrieves an email entry from the database and converts it to a pb.EmailResponse.
...
// GetEmail implements the gRPC GetEmail RPC method.
...
// GetEmailBatch implements the gRPC GetEmailBatch RPC method.
...
// CreateEmail implements the gRPC CreateEmail RPC method.
...
// UpdateEmail implements the gRPC UpdateEmail RPC method.
...
// DeleteEmail implements the gRPC DeleteEmail RPC method.
...
func Serve(db *sql.DB, bind string) {
	...
	mailServer := MailServer{db: db} // Create an instance of the MailServer.

	// Register the MailServer with the gRPC server.
